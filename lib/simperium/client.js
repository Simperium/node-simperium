...
Client.prototype.bucket = function(name, user){
  ...
  var channelId = this.buckets.length,
      bucket    = new Bucket(name, user, this.options.objectStoreProvider),
      channel   = new Channel(this.appId, user.access_token, bucket, this.options.ghostStoreProvider(user, bucket)),
